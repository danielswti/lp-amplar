(function($){
   ...
   /* --------------------------------------------
    ...
    function init_scroll_navigate(){
        ...
        var nav = $(".main-nav"); // pega a nav
        
        $(window).on("scroll", function(){

            // === muda nav ao rolar ===
            if($(this).scrollTop() > 50){
                nav.addClass("scrolled"); // ativa fundo branco + texto preto
            } else {
                nav.removeClass("scrolled"); // volta ao estado inicial (transparente + texto branco)
            }
